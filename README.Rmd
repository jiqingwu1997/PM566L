...
# Step 5
git remote add origin git@github.com:[jiqingwu1997]/PM566L
...
```bash
git commit -a -m "lab 7 https://github.com/USCbiostats/PM566/issues/26"
```
